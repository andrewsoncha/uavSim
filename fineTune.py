...
if __name__ == "__main__":
    ...
    parser.add_argument('-pt', '--pretrained', default=None, help='Path to the pretrained model')
    ...
    if args.pretrained is None:
        print('fineTune.py requires the path to the pretrained model!')
        print('exiting program!')
        exit(1)

    # Added code to load pre-trained model files. -- August 16th, 2026, Andrew Chang.
    pretrained_path = args.pretrained + '/models'
    pretrained_model = agent.load_keras(pretrained_path)
